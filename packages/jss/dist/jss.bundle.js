...
var StyleRule = /*#__PURE__*/function (_BaseStyleRule) {
  ...
  function StyleRule(key, style, options) {
    ...
    if (selector) {
      ...
      _this.id = generateId(_assertThisInitialized(_this), sheet);
...
var ConditionalRule = /*#__PURE__*/function () {
  ...
  _proto.addOrReplaceRule = function addOrReplaceRule(name, style, isReplace, options) {
    var rule = isReplace ? this.rules.replace(name, style, options) : this.rules.add(name, style, options);
    if (!rule) return null;
...
var RuleList = /*#__PURE__*/function () {
  ...
  _proto.addOrReplace = function addOrReplace(name, decl, isReplace, ruleOptions) {
...
var StyleSheet = /*#__PURE__*/function () {
  ...
  _proto.addOrReplaceRule = function addOrReplaceRule(name, decl, isReplace, options) {
  ...
  _proto.replaceRule = function replaceRule(name, decl, options) {
